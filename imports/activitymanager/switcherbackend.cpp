...
template<typename Handler> inline void SwitcherBackend::registerShortcut(const QString &actionName, const QString &text, const QKeySequence &shortcut, Handler &&handler)
{
    ...
    , m_stoppedActivitiesModel(new SortedActivitiesModel({KActivities::Info::Stopped, KActivities::Info::Starting}, this))
{
    ...
    registerShortcut(ACTION_NAME_PREVIOUS_ACTIVITY, i18n("Walk through activities (Reverse)"), Qt::META + Qt::SHIFT + Qt::Key_Tab, &SwitcherBackend::keybdSwitchToPreviousActivity);
    ...
    connect(&m_dropModeHider, &QTimer::timeout, this, [this] { setShouldShowSwitcher(false); });
...
void SwitcherBackend::switchToActivity(Direction direction)
{
    ...
    QTimer::singleShot(0, this, [this, activityToSet]() { setCurrentActivity(activityToSet); });
...
{
    auto message = QDBusMessage::createMethodCall(QStringLiteral("org.kde.plasmashell"), QStringLiteral("/PlasmaShell"), QStringLiteral("org.kde.PlasmaShell"), QStringLiteral("toggleActivityManager"));
