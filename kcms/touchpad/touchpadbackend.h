...
enum class TouchpadInputBackendMode { Unset = 0, WaylandLibinput = 1, XLibinput = 2, XSynaptics = 3 };
...
public:
    ...
    enum TouchpadOffState { TouchpadEnabled, TouchpadTapAndScrollDisabled, TouchpadFullyDisabled };
