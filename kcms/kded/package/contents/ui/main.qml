...
KCM.ScrollViewKCM {
    ...
    KCM.ConfigModule.quickHelp: i18n("<p>This module allows you to have an overview of all plugins of the
...
You can also define whether services should be loaded at startup.</p>
