    ...
    , m_filteredFolderModel(new FilteredFolderModel(m_data->settings(), this))
{
    ...
    KAboutData *about = new KAboutData(QStringLiteral("kcm_baloofile"), i18n("File Search"), QStringLiteral("0.1"), QString(), KAboutLicense::GPL, i18n("Copyright 2007-2010 Sebastian Trüg"));
...
void ServerConfigModule::save()
{
    ...
    if (balooSettings()->indexingEnabled()) {
        ...
        QDBusMessage message = QDBusMessage::createMethodCall(QStringLiteral("org.kde.baloo"), QStringLiteral("/"), QStringLiteral("org.kde.baloo.main"), QStringLiteral("quit"));
