...
KCM.SimpleKCM {
    ...
    Kirigami.FormLayout2 {
        ...
        Kirigami.FormGroup {
            ...
            Kirigami.FormEntry {
                subtitle: i18n("Middle-click to scroll to clicked location")
                contentItem: QQC2.RadioButton {
        ...
        Kirigami.FormGroup {
            ...
            Kirigami.FormEntry {
                title: i18n("When dragging files or folders:")
        ...
        Kirigami.FormGroup {
            ...
            Kirigami.FormEntry {
                ...
                contentItem: QQC2.RadioButton {
                    ...
                    Accessible.description: i18n("In Touch Mode, many elements of the user interface will become larger to more easily accommodate touch interaction.")
