        ...
        Item {
            ...
            RowLayout {
                ...
                Kirigami.TitleSubtitle {
                    id: displayLabel
                    Layout.minimumWidth: Math.min(implicitWidth, Kirigami.Units.gridUnit * 8)
                    // Layout.fillWidth: true
                    title: i18nc("%1 is the name action that is triggered by the key sequences following after :", "%1:", model.display)
                    //wrapMode: Text.Wrap
                    //textFormat: Text.PlainText
                    //level: 5
                }
                KeySequenceItem {
                    id: sendKeySequenceItem
                    visible: model.actionId === "GenerateKeySequence"
                    //keySequence: modelData
                    showClearButton: true
                    patterns: ShortcutPattern.Key
                ...
                QQC2.Button {
                    id: textSnippetCustomizationButton
                    visible: model.actionId === "GenerateTextSnippet"
