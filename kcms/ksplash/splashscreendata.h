...
class SplashScreenData : public KCModuleData
{
    Q_OBJECT

public:
    explicit SplashScreenData(QObject *parent = nullptr, const QVariantList &args = QVariantList());
    SplashScreenSettings *settings() const;
