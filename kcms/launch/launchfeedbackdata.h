...
class LaunchFeedbackData : public KCModuleData
{
    Q_OBJECT

public:
    explicit LaunchFeedbackData(QObject *parent = nullptr, const QVariantList &args = QVariantList());
    LaunchFeedbackSettings *settings() const;
