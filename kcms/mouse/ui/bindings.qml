...
*/
    ...
    ColumnLayout {
        ...
        ListView {
            ...
            model: ListModel {
                ...
                ListElement { trigger: "Pinch with 4 fingers"; triggerSection: "Touchpad Pinch"; component: "Window Management"; componentIcon: "preferences-system-login"; actionText: "Lock Session" }
                ListElement { trigger: "Rotate clockwise with 3 fingers"; triggerSection: "Touchpad Rotate"; component: "Window Management"; componentIcon: "kmix"; actionText: "Increase Volume" }
                ListElement { trigger: "Rotate counter-clockwise with 3 fingers"; triggerSection: "Touchpad Rotate"; component: "Window Management"; componentIcon: "kmix"; actionText: "Decrease Volume" }
                ListElement { trigger: "Rotate clockwise with 4 fingers"; triggerSection: "Touchpad Rotate"; component: "Window Management"; componentIcon: "preferences-system-power-management"; actionText: "Increase Screen Brightness" }
                ListElement { trigger: "Rotate counter-clockwise with 4 fingers"; triggerSection: "Touchpad Rotate"; component: "Window Management"; componentIcon: "preferences-system-power-management"; actionText: "Decrease Screen Brightness" }
            }
                ...
                contentItem: RowLayout {
                    ...
                    QQC2.ToolButton {
                        action: Kirigami.Action {
                            ...
                            //onTriggered: ...open edit sub-page...
                        }
    ...
    Kirigami.PromptDialog {
        ...
        customFooterActions: [
            Kirigami.Action {
                text: i18n("Assign Action…")
                icon.name: selectGestureDialog.editing ? "edit-entry-symbolic" : "list-add-symbolic"
