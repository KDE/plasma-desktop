...
//	QAction* createLayoutShortcutActon(const LayoutUnit& layoutUnit, const XkbRules* rules, bool autoload);
//	KAction* setShortcut(LayoutUnit& layoutUnit, const QKeySequence& keySequence, const Rules* rules);
//	void setLayoutShortcuts(QList<LayoutUnit>& layoutUnits, const XkbRules* rules);
	void setToggleShortcut(const QKeySequence& keySequence);
//	void loadLayoutShortcuts(QList<LayoutUnit>& layoutUnits, const XkbRules* rules);
