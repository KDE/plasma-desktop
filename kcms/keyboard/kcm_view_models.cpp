...
QWidget *LabelEditDelegate::createEditor(QWidget *parent, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    ...
    if (lineEdit != nullptr) {
        ...
        connect(lineEdit, &QLineEdit::textEdited, this, [this, lineEdit]() { Q_EMIT const_cast<LabelEditDelegate *>(this)->commitData(lineEdit); });
    }
    return widget;
}
...
QWidget *VariantComboDelegate::createEditor(QWidget *parent, const QStyleOptionViewItem & /* option */, const QModelIndex &index) const
{
    ...
    connect(editor, &QComboBox::currentTextChanged, this, [this, editor]() { Q_EMIT const_cast<VariantComboDelegate *>(this)->commitData(editor); });
    return editor;
}
...
QWidget *KKeySequenceWidgetDelegate::createEditor(QWidget *parent, const QStyleOptionViewItem & /*option*/, const QModelIndex &index) const
{
    ...
    connect(editor, &KKeySequenceWidget::keySequenceChanged, this, [this, editor]() { Q_EMIT const_cast<KKeySequenceWidgetDelegate *>(this)->commitData(editor); });
