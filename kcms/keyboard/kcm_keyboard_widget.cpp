...
void KCMKeyboardWidget::addLayout()
{
    ...
    AddLayoutDialog dialog(rules, keyboardConfig->isFlagShown() ? flags : nullptr, keyboardConfig->keyboardModel, keyboardConfig->xkbOptions, keyboardConfig->isLabelShown(), this);
