...
void KCMKeyboardWidget::scrollToGroupShortcut()
{
    ...
    if (!uiWidget->kcfg_xkbOptionsEnabled->isChecked()) {
        uiWidget->kcfg_xkbOptionsEnabled->setChecked(true);
    }
...
void KCMKeyboardWidget::initializeXkbOptionsUI()
{
    ...
    connect(uiWidget->kcfg_xkbOptionsEnabled, &QAbstractButton::toggled, this, &KCMKeyboardWidget::configureXkbOptionsChanged);
    connect(uiWidget->kcfg_xkbOptionsEnabled, &QAbstractButton::toggled, uiWidget->xkbOptionsTreeView, &QWidget::setEnabled);
}

void KCMKeyboardWidget::configureXkbOptionsChanged()
{
    if (uiWidget->kcfg_xkbOptionsEnabled->isChecked() && keyboardConfig->xkbOptions().isEmpty()) {
