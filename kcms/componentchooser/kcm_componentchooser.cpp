...
K_PLUGIN_FACTORY(KCMComponentChooserFactory, registerPlugin<KCMComponentChooser>();)
    ...
    : KCModule(parent)
{
    ...
    KAboutData *about = new KAboutData(QStringLiteral("kcmcomponentchooser"), i18n("Component Chooser"), QStringLiteral("1.0"), QString(), KAboutLicense::GPL, i18n("(c), 2002 Joseph Wenninger"));
