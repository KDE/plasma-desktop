...
QStringList archiveMimetypes{"application/x-tar",
...
{
    saveMimeTypeAssociations(archiveMimetypes, m_applications[m_index].toMap()[QStringLiteral("storageId")].toString());
}
