...
KCM.SimpleKCM {
    ...
    readonly property var deviceControllerType: device !== null ? device.controllerTypeName : null
    readonly property var deviceConnectionType: device !== null ? device.connectionType : null
