...
static QStringList kButtonNames = {
    ...
    i18nc("The button under the game controller's left analog stick", "left stick"),
    i18nc("The button under the game controller's right analog stick", "right stick"),
...
static QStringList kConnectionTypeString = {
    i18nc("Unknown controller connection type", "Unknown type"),
...
QString Device::controllerType() const
{
    if (m_controller) {
