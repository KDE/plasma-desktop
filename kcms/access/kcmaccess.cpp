...
void KAccessConfig::configureZoomMagnifyShortcuts()
{
    ...
    if (zoomMagnifierSettings()->zoom()) {
        ...
        // actionCollection->setConfigGroup(QStringLiteral("Zoom")); // TODO: Needed?
        // actionCollection->setConfigGlobal(true); // TODO: Needed?

        QAction *a;
        a = actionCollection->addAction(KStandardActions::ZoomIn);
        a->setProperty("isConfigurationAction", true); // TODO: Are any of these setProperty isConfigurationAction true needed?
        ...
        // actionCollection->setConfigGroup(QStringLiteral("Magnifier")); // TODO: Needed?
        // actionCollection->setConfigGlobal(true); // TODO: Needed?
