...
Kirigami.FormLayout {
    ...
    RowLayout {
        ...
        Item {
            implicitWidth: Qt.application.layoutDirection === Qt.RightToLeft ? magnifierRadioButton.contentItem.rightPadding : magnifierRadioButton.contentItem.leftPadding // Simulate left padding for child FormLayout
        }
        ...
        Kirigami.FormLayout {
            ...
            QQC2.ComboBox {
                ...
                model: [i18n("Scale"), i18n("Keep"), i18n("Hide")]
            ...
            QQC2.ComboBox {
                ...
                model: [i18n("Proportional"), i18n("Centered"), i18n("Push"), i18n("Disabled")]
            ...
            QQC2.CheckBox {
                text: i18n("Enable focus tracking")
            ...
            QQC2.CheckBox {
                text: i18n("Enable text caret tracking")
            ...
            RowLayout {
                ...
                KQuickControls.KeySequenceItem {
                    ...
                    Component.onCompleted: {
                        if (kcm.isPlatformX11) {
                            // HACK: 'enabled' property doesn't work. It remains above
                            // in case it may be fixed in the future, but otherwise:
                            zoomPointerAxisGestureModifiersBox.children.forEach((child) => child.enabled = false)
                        }
                    }
