...
Kirigami.Form {
    ...
    Kirigami.FormGroup {
        Kirigami.FormEntry {
            title: i18ndc("kcm_tablet", "@label:listbox", "Map to screen:")
        ...
        Kirigami.FormEntry {
            title: i18ndc("kcm_tablet", "@label:listbox", "Orientation:")
            contentItem: QQC2.ComboBox {
        ...
        Kirigami.FormEntry {
            title:i18ndc("kcm_tablet", "@label:listbox", "Mapped Area:")
            contentItem: QQC2.ComboBox {
                id: outputAreaCombo
        ...
        Kirigami.FormEntry {
            contentItem: ExternalScreenMapping {
                id: mapping
