...
Item {
    ...
    Kirigami.PlaceholderMessage {
        text: i18nd("kcm_tablet", "No configurable pad inputs found")
        explanation: i18n("There's no buttons, dials, or other pad inputs detected. This could be an indication of a missing driver for this device.")
    ...
    Kirigami.FormLayout {
        ...
        Repeater {
            id: ringRepeater
            model: root.padDevice?.tabletPadRingCount ?? 0
        ...
        Repeater {
            id: dialRepeater
            model: root.padDevice?.tabletPadDialCount ?? 0
        ...
        Repeater {
            id: buttonsRepeater
            model: root.padDevice?.tabletPadButtonCount ?? 0
