...
public:
    ...
    Q_SCRIPTABLE void assignPadRingMapping(const QString &deviceName, uint button, const InputSequence &keySequence);
    ...
    Q_SCRIPTABLE InputSequence padRingMapping(const QString &deviceName, uint button) const;
