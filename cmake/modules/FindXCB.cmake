...
#   XCB_XINPUT_FOUND     XCB_XINPUT_INCLUDE_DIR     XCB_XINPUT_LIBRARIES
#
...
IF (NOT WIN32)
  ...
  FIND_PATH(XCB_XINPUT_INCLUDE_DIR      NAMES xcb/xinput.h          HINTS ${PKG_XCB_INCLUDE_DIRS})
  ...
  FIND_LIBRARY(XCB_XINPUT_LIBRARIES      NAMES xcb-xinput       HINTS ${PKG_XCB_LIBRARY_DIRS})
  ...
  set(XCB_INCLUDE_DIR ${XCB_XCB_INCLUDE_DIR} ${XCB_COMPOSITE_INCLUDE_DIR} ${XCB_XFIXES_INCLUDE_DIR}
          ...
          ${XCB_XTEST_INCLUDE_DIR} ${XCB_XINPUT_INCLUDE_DIR})
  ...
  set(XCB_LIBRARIES ${XCB_XCB_LIBRARIES} ${XCB_COMPOSITE_LIBRARIES} ${XCB_XFIXES_LIBRARIES}
          ...
          ${XCB_XTEST_LIBRARIES} ${XCB_XINPUT_LIBRARIES})
  ...
  FIND_PACKAGE_HANDLE_STANDARD_ARGS(XCB_XINPUT      DEFAULT_MSG  XCB_XINPUT_LIBRARIES      XCB_XINPUT_INCLUDE_DIR)
  ...
  MARK_AS_ADVANCED(
        ...
        XCB_XINPUT_INCLUDE_DIR      XCB_XINPUT_LIBRARIES
  )
