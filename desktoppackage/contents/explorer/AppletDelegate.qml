    ...
    ColumnLayout {
        ...
        Item {
            ...
            Kirigami.ColoredBadgeLabel {
                ...
                width: (running && delegate.GridView.isCurrentItem) ? height : implicitWidth

                color: (running && delegate.GridView.isCurrentItem) ? Kirigami.Theme.highlightedTextColor : Kirigami.Theme.textColor
                backgroundColor: (running && delegate.GridView.isCurrentItem) ? Kirigami.Theme.highlightColor : Kirigami.Theme.positiveBackgroundColor
                backgroundRadius: (running && delegate.GridView.isCurrentItem) ? height / 2 : Kirigami.Units.cornerRadius
