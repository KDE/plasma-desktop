...
KSvg.FrameSvgItem {
    ...
    KSvg.SvgItem {
        ...
        x: dialogRoot.vertical ? 0 : Math.round(offsetHandle.x + offsetHandle.width / 2) + (panel.alignment === Qt.AlignLeft ? - panel.width / 2 : panel.alignment === Qt.AlignRight ? panel.width / 2 : 0)
        y: dialogRoot.vertical ?  Math.round(offsetHandle.y + offsetHandle.height / 2) + (panel.alignment === Qt.AlignLeft ? - panel.height / 2 : panel.alignment === Qt.AlignRight ? panel.height / 2 : 0) : 0
    }
