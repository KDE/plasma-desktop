...
PlasmaComponents.Button {
    text: panel.location == PlasmaCore.Types.LeftEdge || panel.location == PlasmaCore.Types.RightEdge ? i18nc("org.kde.plasma.desktop", "Width") : i18nc("org.kde.plasma.desktop", "Height")
