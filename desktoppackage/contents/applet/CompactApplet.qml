...
PlasmaCore.ToolTipArea {
    ...
    PlasmaCore.Dialog {
        ...
        backgroundHints: (plasmoid.containmentDisplayHints & PlasmaCore.Types.ContainmentOpaque) ? PlasmaCore.Dialog.SolidBackground : PlasmaCore.Dialog.StandardBackground
