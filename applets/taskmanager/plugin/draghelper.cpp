...
{
    QMetaObject::invokeMethod(this, "startDragInternal", Qt::QueuedConnection, Q_ARG(QQuickItem *, item), Q_ARG(QString, mimeType), Q_ARG(QVariant, mimeData), Q_ARG(QUrl, url), Q_ARG(QIcon, icon));
}
