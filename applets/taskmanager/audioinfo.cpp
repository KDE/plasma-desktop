    ...
    : QObject()
{
    connect(PulseAudioQt::Context::instance(), &PulseAudioQt::Context::sinkInputAdded, this, [this](PulseAudioQt::SinkInput *stream) {
        connect(stream, &PulseAudioQt::SinkInput::mutedChanged, this, &AudioInfo::mutedChanged);
...
QList<PulseAudioQt::SinkInput *> AudioInfo::streamsForAppId(const QString &appId) const
{
...
QList<PulseAudioQt::SinkInput *> AudioInfo::streamsForPid(qint64 pid) const
{
    QList<PulseAudioQt::SinkInput *> ret;
...
QList<PulseAudioQt::SinkInput *> AudioInfo::streamsForAppName(const QString &appName) const
{
    QList<PulseAudioQt::SinkInput *> ret;
    const auto streams = PulseAudioQt::Context::instance()->sinkInputs();
    for (auto *stream : streams) {
...
void AudioInfo::classBegin()
{
}

void AudioInfo::componentComplete()
{
    m_complete = true;
    update();
}
