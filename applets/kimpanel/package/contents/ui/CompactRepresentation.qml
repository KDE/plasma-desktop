...
Item {
    ...
    property PlasmaCore.DataSource dataEngine
    ...
    Flow {
        ...
        Item {
            ...
            StatusIcon {
                ...
                width: items.iconSize
                height: items.iconSize
                label: dataEngine.data["statusbar"]["CurrentTag"]
                icon: dataEngine.data["statusbar"]["CurrentIconName"]
                tip: "Currently Active Layout"
    ...
    MainContextMenu {
        ...
        onConfigureClicked: {
            dataSource.data["statusbar"]["LayoutModels"].openConfigDialog();
        }
    }
